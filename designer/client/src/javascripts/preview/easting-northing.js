 ...
 */
export class EastingNorthingDomElements extends QuestionDomElements {
  constructor() {
    super()
...
export class EastingNorthingEventListeners extends EventListeners {
  /**
   * @param {EastingNorthingQuestion} question
   * @param {EastingNorthingDomElements} baseElements
   */
...
/**
 * @import { ListenerRow, LocationSettings, QuestionElements, EastingNorthingQuestion } from '@defra/forms-model'
 */
