 ...
 */
export class LatLongDomElements extends QuestionDomElements {
  constructor() {
    super()
...
export class LatLongEventListeners extends EventListeners {
  /**
   * @param {LatLongQuestion} question
   * @param {LatLongDomElements} baseElements
   */
